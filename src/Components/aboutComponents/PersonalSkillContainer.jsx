            ...
            <div className='personalSkillContainer'>
                ...
                <div className='skill-inner-container'>
                    <div className='personal-skill'>
                        <h1 className='skill-percent' style={{ color: '#ffb3b3' }}>75%</h1>
                    ...
                    <div className='personal-skill'>
                        <h1 className='skill-percent' style={{ color: '#b3d9ff' }}>80%</h1>
                        <div className='skill-bar'>
                    ...
                    <div className='personal-skill'>
                        <h1 className='skill-percent' style={{ color: '#d9ffb3' }}>75%</h1>
                        <div className='skill-bar'>
                    ...
                    <div className='personal-skill'>
                        <h1 className='skill-percent' style={{ color: '#ffd9b3' }}>80%</h1>
                        <div className='skill-bar'>
                    ...
                    <div className='personal-skill'>
                        <h1 className='skill-percent' style={{ color: '#ffb3e6' }}>78%</h1>
                        <div className='skill-bar'>
                    ...
                    <div className='personal-skill'>
                        <h1 className='skill-percent' style={{ color: '#e6ffb3' }}>80%</h1>
                        <div className='skill-bar'>
